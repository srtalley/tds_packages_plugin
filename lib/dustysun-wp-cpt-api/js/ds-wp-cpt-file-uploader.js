  ...
  function showImageGalleryUploader() {
    ...
    imageGalleryUploadFrame.on('select', function() {
      ...
      for (i = 0; i < attachments.length; ++i) {
        ...
        // console.log(attachments[i].attributes.sizes.thumbnail.url);
        var imgGalleryContainerRemoveable = $( '#' + fieldIdInput + imageI + '-container' );
        // Send the attachment URL to our custom image input field.
        $(imgGalleryContainerRemoveable).append( '<img src="'+attachments[i].attributes.sizes.thumbnail.url+'" alt="" style="max-width:100%;"/>' );
